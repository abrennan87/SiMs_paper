...
%Although each search has a different set of assumptions, this allows us to see that each technique is complementary and offers strong constraints in certain regions of parameter space.
