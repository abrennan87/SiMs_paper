...
Whereas the ATLAS analysis uses a shape fit of the mass distribution of the large radius jet, we just regard the number of events in the signal region, since the data points of the m_jet distribution were not published. \comm{check!!!}
