...
\comm{Note to Johanna: Here you should discuss the original intention of the \monoWZ analysis. Also comment on any validation you did in order to confirm that you could use the results of the analysis - the bulk of this should go into the \monoWZ section of App. A. Lastly, discuss or list the cuts used in the analysis and the uncertainties associated with the results. See \monojet and \monoZ or \monojet or \monoWZ sections above.}
